 ...
 */
final class FlagAttribute extends MetricHolderAttribute<RatedFlagRecorder, ValueChangedNotification> {
    ...
    FlagAttribute(final String name, final AttributeDescriptor descriptor) {
        super(ValueChangedNotification.class, name, TYPE, descriptor, RatedFlagRecorder::new);
    }
    ...
    @Override
    void updateMetric(final RatedFlagRecorder metric, final ValueChangedNotification notification) {
