 ...
 * @version 2.0
 */
final class RangedTimerAttribute extends MetricHolderAttribute<RangedTimerRecorder, StopwatchMeasurement> {
    ...
    private RangedTimerAttribute(final String name, final AttributeDescriptor descriptor, final Duration rangeStart, final Duration rangeEnd){
        super(StopwatchMeasurement.class, name, TYPE, descriptor, (n) -> new RangedTimerRecorder(n, rangeStart, rangeEnd));
    }
    ...
    @Override
    void updateMetric(final RangedTimerRecorder metric, final StopwatchMeasurement notification) {
