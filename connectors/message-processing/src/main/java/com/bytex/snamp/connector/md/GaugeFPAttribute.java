 ...
 * @since 2.0
 */
final class GaugeFPAttribute extends MetricHolderAttribute<RatedGaugeFPRecorder, ValueChangedNotification> {
    ...
    GaugeFPAttribute(final String name, final AttributeDescriptor descriptor) {
        super(ValueChangedNotification.class, name, TYPE, descriptor, RatedGaugeFPRecorder::new);
    }
    ...
    @Override
    void updateMetric(RatedGaugeFPRecorder metric, ValueChangedNotification notification) {
