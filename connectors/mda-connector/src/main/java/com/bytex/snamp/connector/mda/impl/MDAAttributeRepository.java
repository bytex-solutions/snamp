...
import com.bytex.snamp.connector.mda.MDAAttributeInfo;
 ...
 * @since 1.0
 */
public abstract class MDAAttributeRepository extends com.bytex.snamp.connector.mda.MDAAttributeRepository<MDAAttributeInfo> {
