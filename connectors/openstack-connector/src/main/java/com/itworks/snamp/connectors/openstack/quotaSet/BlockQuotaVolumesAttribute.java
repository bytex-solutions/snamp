 ...
 * @since 1.0
 */
public final class BlockQuotaVolumesAttribute extends AbstractBlockQuotaAttribute<Integer> {
    public static final String NAME = "blockVolumes";
    static final String DESCRIPTION = "Maximum number of volumes";
    static final SimpleType<Integer> TYPE = SimpleType.INTEGER;

    public BlockQuotaVolumesAttribute(final String tenantID,
