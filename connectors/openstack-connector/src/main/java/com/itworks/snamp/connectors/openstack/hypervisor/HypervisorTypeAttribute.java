 ...
 * @since 1.0
 */
public final class HypervisorTypeAttribute extends AbstractHypervisorAttribute<String> {
    public static final String NAME = "type";
    static final String DESCRIPTION = "Type of hypervisor";
    static final SimpleType<String> TYPE = SimpleType.STRING;

    public HypervisorTypeAttribute(final String hypervisorID,
