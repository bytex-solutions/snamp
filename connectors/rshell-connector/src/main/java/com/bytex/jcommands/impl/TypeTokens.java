...
public final class TypeTokens {
    ...
    /**
     * Represents type of the {@link com.bytex.jcommands.impl.XmlParsingResultType#DICTIONARY} object.
     */
    public static final TypeToken<Map<String, ?>> DICTIONARY_TYPE_TOKEN = new TypeToken<Map<String, ?>>() {};

    /**
     * Represents type of the {@link com.bytex.jcommands.impl.XmlParsingResultType#TABLE} object.
     */
