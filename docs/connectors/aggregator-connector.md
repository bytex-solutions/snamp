...
---- | ----
periodicAttributeQuery | Periodically reads value of the foreign attribute and emits value as notification. The query period is defined using _notificationFrequency_ configuration parameter
