...
import com.itworks.snamp.connectors.ChannelSupport;
...
import static com.itworks.snamp.connectors.ChannelSupport.ChannelListener;
...
public abstract class ChannelPipeline<TOutput> implements ChannelListener {
     ...
     * @see ChannelSupport#addChannelListener(String, String, com.itworks.snamp.connectors.ChannelSupport.ChannelListener)
     */
