...
import com.itworks.snamp.configuration.AgentConfigurationStorage;
import com.itworks.snamp.configuration.ConfigurationFormat;
...
final class Bootstrapper implements HostingContext {
    private static final String CONFIG_STORAGE_LOG_NAME = "com.itworks.snamp.configuration.storage";
