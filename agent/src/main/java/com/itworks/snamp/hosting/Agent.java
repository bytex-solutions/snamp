package com.itworks.snamp.hosting;

import com.itworks.snamp.adapters.AbstractAdapter;
import com.itworks.snamp.adapters.Adapter;
import com.itworks.snamp.adapters.NotificationPublisher;
import com.itworks.snamp.connectors.*;
import com.itworks.snamp.core.communication.CommunicableObject;
import com.itworks.snamp.core.communication.Communicator;
import com.itworks.snamp.core.communication.InMemoryCommunicator;
import com.itworks.snamp.hosting.management.AbstractAgentManager;
import com.itworks.snamp.hosting.management.AgentManager;
import com.itworks.snamp.hosting.management.ConsoleAgentManager;
...
public final class Agent extends AbstractPlatformService implements AutoCloseable {
    ...
    private static PluginManager loadPlugins(){
        ...
        pluginManager.addPluginsFrom(URI.create("classpath://com.itworks.snamp.connectors.**"));
        pluginManager.addPluginsFrom(URI.create("classpath://com.itworks.snamp.adapters.**"));
        pluginManager.addPluginsFrom(URI.create("classpath://com.itworks.snamp.hosting.management.**"));
