...
import com.itworks.snamp.AbstractConcurrentResourceAccess;
...
public class ConsoleAgentManager extends AbstractAgentManager {
    ...
    protected boolean doCommand(final String commmand, final PrintStream output) {
        return readContext(new AbstractConcurrentResourceAccess.ConsistentAction<HostingContext, Boolean>() {
            @Override
