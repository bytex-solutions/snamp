...
public interface ManagementConnector extends Iterable<String>, AutoCloseable {
     ...
     */
    public NotificationMetadata enableNotifications(final String category, final Map<String, String> options);
     ...
     */
    public NotificationMetadata getNotificationInfo(final String category);
     ...
     */
    public Object subscribe(final String category, final NotificationListener<? extends Notification> listener) throws UnsupportedOperationException;
