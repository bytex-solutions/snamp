...
@Component({
    ...
    styleUrls: ['app/configuration/components/templates/css/inline-edit.component.css'],
    templateUrl: 'app/configuration/components/templates/inline-edit.component.html'
})
