...
var MainComponent = (function () {
    function MainComponent(apiClient, _router, modal, overlay, vcRef) {
        ...
        this.checkersType = CheckerType.generateTypes();
...
var CheckerType = (function () {
    function CheckerType(id, description) {
        this.id = id;
        this.description = description;
    }
    CheckerType.generateTypes = function () {
        var _value = [];
