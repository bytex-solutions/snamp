...
var PTable = (function () {
    ...
    PTable.prototype.addNewParameter = function () {
        this.entity.setParameter(new model_entity_1.KeyValue("newParamKey", "newParamValue"));
