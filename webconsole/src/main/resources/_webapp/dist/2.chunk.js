...
var Dashboard = (function () {
    ...
    Dashboard.prototype.ngAfterViewInit = function () {
        var _this = this;
        this.subscription = TimerObservable_1.TimerObservable.create(2000, 1000).subscribe(function (t) {
    ...
    Dashboard.prototype.loadMetricsOnInstancesSelected = function () {
        ...
        var _obsInstances = this.http.post(app_restClient_1.REST.CHART_METRICS_BY_INSTANCES, this.selectedInstances)
            .map(function (res) {
            var _data = res.json();
            var _values = [];
            for (var i in _data) {
