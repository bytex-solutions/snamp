...
var Dashboard = (function () {
    ...
    Dashboard.prototype.isRateMetricSelected = function (metric) {
        return this.selectedRateMetrics.find(function (value) { return value == metric; }).length > 0;
    };
