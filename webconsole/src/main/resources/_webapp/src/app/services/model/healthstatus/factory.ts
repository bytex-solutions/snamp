...
import { ResourceConnectorMalfunction } from "./resource.connector.malfunction.status";
...
export class StatusFactory {
    ...
    public static healthStatusFromJSON(name:string, json:any):HealthStatus {
        ...
        switch(json["@type"]) {
            ...
            case HealthStatus.RESOURCE_CONNECTOR_MALFUNCTION_TYPE:
                _value = new ResourceConnectorMalfunction();
                (<ResourceConnectorMalfunction>_value).jmxError = json["error"];
                break;
        ...
        if (_value instanceof MalfunctionStatus) {
            (<MalfunctionStatus>_value).level = json["level"];
        }
        return _value;
    }
    ...
    public static healthStatusFromObject(json:any):HealthStatus {
        ...
        switch(json["innerType"]) {
            case HealthStatus.OK_TYPE:
                ...
                break;
            case HealthStatus.RESOURCE_CONNECTOR_MALFUNCTION_TYPE:
                _value = Object.assign(new ResourceConnectorMalfunction(), json);
                break;
