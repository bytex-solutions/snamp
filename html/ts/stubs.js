(function (com) {
    (function (snamp) {
        (function (models) {
            function getSummary() {
                return [
                    new bundle(type, "connector", "JMX connector", "Provides information about remote or local JMX bean " + "according to configuration file propertiess", new bundleStatus(5, 10, [
                    ...
                    new bundle(type, "adapter", "SNMP adapter", "Provides SNMP OIDs from any source", new bundleStatus(1, 1, [
                    ...
                    new bundle(type, "connector", "WMB connector", "Links to Websphere Message Broker and returns some information from there", new bundleStatus(1, 1, [
