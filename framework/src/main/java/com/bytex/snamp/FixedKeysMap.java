...
final class FixedKeysMap<K, V> implements Map<K, V> {
    private static final class DynamicEntry<K, V> implements Entry<K, V>{
        ...
        private final BiFunction<? super K, ? super V, ? extends V> keySetter;

        private DynamicEntry(final K key,
                             final Function<? super K, ? extends V> keyGetter,
        ...
        public V setValue(final V value) {
            if(keySetter == null)
                ...
                return keySetter.apply(key, value);
        }
        ...
        private boolean equals(final DynamicEntry<?, ?> other) {
            return Objects.equals(key, other.key) &&
                    Objects.equals(keyGetter, other.keyGetter) &&
                    Objects.equals(keySetter, other.keySetter);
        }

        @Override
        public boolean equals(final Object other) {
            return other instanceof DynamicEntry<?, ?> && equals((DynamicEntry<?, ?>) other);
        }
    }
    ...
    public boolean containsValue(final Object value) {
        for(final K key: keys)
            if(Objects.equals(value, keyGetter.apply(key)))
                return true;
        return false;
    }
