...
public interface SelectableAdapterParameterDescriptor extends ParameterDescription {
     ...
     * @param connectionOptions Configuration parameters associated with the adapter (see {@link com.bytex.snamp.configuration.AgentConfiguration.ResourceAdapterConfiguration#getParameters()}).
