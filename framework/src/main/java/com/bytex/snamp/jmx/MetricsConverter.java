...
public final class MetricsConverter {
    ...
    private static void fillRate(final Rate rate, final CompositeDataBuilder output){
        output
                ...
                .put(MEAN_RATE_PER_15_MINUTES_FIELD, rate.getMeanRate(MetricsInterval.QUARTER_OF_HOUR))
                .put(MEAN_RATE_PER_HOUR_FIELD, rate.getMeanRate(MetricsInterval.HOUR))
                .put(MEAN_RATE_PER_12_HOURS_FIELD, rate.getMeanRate(MetricsInterval.HALF_DAY))
                ...
                .put(RATE_FOR_LAST_15_MINUTES_FIELD, rate.getLastRate(MetricsInterval.QUARTER_OF_HOUR))
                .put(RATE_FOR_LAST_HOUR_FIELD, rate.getLastRate(MetricsInterval.HOUR))
                .put(RATE_FOR_LAST_12_HOURS_FIELD, rate.getLastRate(MetricsInterval.HALF_DAY))
                ...
                .put(MAX_RATE_PER_15_MINUTES_FIELD, rate.getMaxRate(MetricsInterval.QUARTER_OF_HOUR))
                .put(MAX_RATE_PER_HOUR_FIELD, rate.getMaxRate(MetricsInterval.HOUR))
                .put(MAX_RATE_PER_12_HOURS_FIELD, rate.getMaxRate(MetricsInterval.HALF_DAY))
                ...
                .put(MAX_RATE_PER_SECOND_FOR_LAST_15_MINUTES_FIELD, rate.getLastMaxRatePerSecond(MetricsInterval.QUARTER_OF_HOUR))
                .put(MAX_RATE_PER_SECOND_FOR_LAST_HOUR_FIELD, rate.getLastMaxRatePerSecond(MetricsInterval.HOUR))
                .put(MAX_RATE_PER_SECOND_FOR_LAST_12_HOURS_FIELD, rate.getLastMaxRatePerSecond(MetricsInterval.HALF_DAY))
                ...
                .put(MAX_RATE_PER_MINUTE_FOR_LAST_15_MINUTES_FIELD, rate.getLastMaxRatePerSecond(MetricsInterval.QUARTER_OF_HOUR))
                .put(MAX_RATE_PER_MINUTE_FOR_LAST_HOUR_FIELD, rate.getLastMaxRatePerSecond(MetricsInterval.HOUR))
                .put(MAX_RATE_PER_MINUTE_FOR_LAST_12_HOURS_FIELD, rate.getLastMaxRatePerSecond(MetricsInterval.HALF_DAY))
    ...
    private static void fillGaugeFP(final GaugeFP gauge, final CompositeDataBuilder output) {
        output
                ...
                .put(MEDIAN_VALUE_FIELD, gauge.getQuantile(0.5F))
                .put(PERCENTILE_90_FIELD, gauge.getQuantile(0.9F))
                ...
                .put(MAX_VALUE_FOR_LAST_15_MINUTES_FIELD, gauge.getLastMaxValue(MetricsInterval.QUARTER_OF_HOUR))
                .put(MAX_VALUE_FOR_LAST_HOUR_FIELD, gauge.getLastMaxValue(MetricsInterval.HOUR))
                .put(MAX_VALUE_FOR_LAST_12_HOURS_FIELD, gauge.getLastMaxValue(MetricsInterval.HALF_DAY))
                ...
                .put(MIN_VALUE_FOR_LAST_15_MINUTES_FIELD, gauge.getLastMinValue(MetricsInterval.QUARTER_OF_HOUR))
                .put(MIN_VALUE_FOR_LAST_HOUR_FIELD, gauge.getLastMinValue(MetricsInterval.HOUR))
                .put(MIN_VALUE_FOR_LAST_12_HOURS_FIELD, gauge.getLastMinValue(MetricsInterval.HALF_DAY))
    ...
    private static void fillFlag(final Flag flag, final CompositeDataBuilder fields){
        fields
                ...
                .put(TRUE_COUNT_FOR_LAST_15_MINUTES_FIELD, flag.getLastCount(MetricsInterval.QUARTER_OF_HOUR, true))
                .put(TRUE_COUNT_FOR_LAST_HOUR_FIELD, flag.getLastCount(MetricsInterval.HOUR, true))
                .put(TRUE_COUNT_FOR_LAST_12_HOURS_FIELD, flag.getLastCount(MetricsInterval.HALF_DAY, true))
                ...
                .put(FALSE_COUNT_FOR_LAST_15_MINUTES_FIELD, flag.getLastCount(MetricsInterval.QUARTER_OF_HOUR, false))
                .put(FALSE_COUNT_FOR_LAST_HOUR_FIELD, flag.getLastCount(MetricsInterval.HOUR, false))
                .put(FALSE_COUNT_FOR_LAST_12_HOURS_FIELD, flag.getLastCount(MetricsInterval.HALF_DAY, false))
                ...
                .put(RATIO_FOR_LAST_15_MINUTES_FIELD, flag.getLastRatio(MetricsInterval.QUARTER_OF_HOUR))
                .put(RATIO_FOR_LAST_HOUR_FIELD, flag.getLastRatio(MetricsInterval.HOUR))
                .put(RATIO_FOR_LAST_12_HOURS_FIELD, flag.getLastRatio(MetricsInterval.HALF_DAY))
    ...
    private static void fillTimer(final Timer timer, final CompositeDataBuilder output) {
        output
                ...
                .put(MEDIAN_VALUE_FIELD, timer.getQuantile(0.5F))
                .put(PERCENTILE_90_FIELD, timer.getQuantile(0.9F))
                ...
                .put(MAX_VALUE_FOR_LAST_15_MINUTES_FIELD, timer.getLastMaxValue(MetricsInterval.QUARTER_OF_HOUR))
                .put(MAX_VALUE_FOR_LAST_HOUR_FIELD, timer.getLastMaxValue(MetricsInterval.HOUR))
                .put(MAX_VALUE_FOR_LAST_12_HOURS_FIELD, timer.getLastMaxValue(MetricsInterval.HALF_DAY))
                ...
                .put(MIN_VALUE_FOR_LAST_15_MINUTES_FIELD, timer.getLastMinValue(MetricsInterval.QUARTER_OF_HOUR))
                .put(MIN_VALUE_FOR_LAST_HOUR_FIELD, timer.getLastMinValue(MetricsInterval.HOUR))
                .put(MIN_VALUE_FOR_LAST_12_HOURS_FIELD, timer.getLastMinValue(MetricsInterval.HALF_DAY))
                ...
                .put(MEAN_TASKS_FOR_15_MINUTES_FIELD, timer.getMeanNumberOfCompletedTasks(MetricsInterval.QUARTER_OF_HOUR))
                .put(MEAN_TASKS_PER_HOUR_FIELD, timer.getMeanNumberOfCompletedTasks(MetricsInterval.HOUR))
                .put(MEAN_TASKS_FOR_12_HOURS_FIELD, timer.getMeanNumberOfCompletedTasks(MetricsInterval.HALF_DAY))
                ...
                .put(MIN_TASKS_FOR_15_MINUTES_FIELD, timer.getMinNumberOfCompletedTasks(MetricsInterval.QUARTER_OF_HOUR))
                .put(MIN_TASKS_PER_HOUR_FIELD, timer.getMinNumberOfCompletedTasks(MetricsInterval.HOUR))
                .put(MIN_TASKS_FOR_12_HOURS_FIELD, timer.getMinNumberOfCompletedTasks(MetricsInterval.HALF_DAY))
                ...
                .put(MAX_TASKS_FOR_15_MINUTES_FIELD, timer.getMaxNumberOfCompletedTasks(MetricsInterval.QUARTER_OF_HOUR))
                .put(MAX_TASKS_PER_HOUR_FIELD, timer.getMaxNumberOfCompletedTasks(MetricsInterval.HOUR))
                .put(MAX_TASKS_FOR_12_HOURS_FIELD, timer.getMaxNumberOfCompletedTasks(MetricsInterval.HALF_DAY))
    ...
    private static void fillRanged(final Ranged ranged, final CompositeDataBuilder output){
        output
                ...
                .put(LESS_THAN_RANGE_LAST_15_MINUTES_FIELD, ranged.getPercentOfLessThanRange(MetricsInterval.QUARTER_OF_HOUR))
                .put(LESS_THAN_RANGE_LAST_HOUR_FIELD, ranged.getPercentOfLessThanRange(MetricsInterval.HOUR))
                .put(LESS_THAN_RANGE_LAST_12_HOURS_FIELD, ranged.getPercentOfLessThanRange(MetricsInterval.HALF_DAY))
                ...
                .put(GREATER_THAN_RANGE_LAST_15_MINUTES_FIELD, ranged.getPercentOfGreaterThanRange(MetricsInterval.QUARTER_OF_HOUR))
                .put(GREATER_THAN_RANGE_LAST_HOUR_FIELD, ranged.getPercentOfGreaterThanRange(MetricsInterval.HOUR))
                .put(GREATER_THAN_RANGE_LAST_12_HOURS_FIELD, ranged.getPercentOfGreaterThanRange(MetricsInterval.HALF_DAY))
                ...
                .put(IS_IN_RANGE_LAST_15_MINUTES_FIELD, ranged.getPercentOfValuesIsInRange(MetricsInterval.QUARTER_OF_HOUR))
                .put(IS_IN_RANGE_LAST_HOUR_FIELD, ranged.getPercentOfValuesIsInRange(MetricsInterval.HOUR))
                .put(IS_IN_RANGE_LAST_12_HOURS_FIELD, ranged.getPercentOfValuesIsInRange(MetricsInterval.HALF_DAY))
    ...
    private static void fillArrivals(final Arrivals arrivals, final CompositeDataBuilder output){
        ...
        output
                ...
                .put(MEAN_AVAILABILITY_LAST_15_MINUTES_FIELD, arrivals.getLastMeanAvailability(MetricsInterval.QUARTER_OF_HOUR))
                .put(MEAN_AVAILABILITY_LAST_HOUR_FIELD, arrivals.getLastMeanAvailability(MetricsInterval.HOUR))
                .put(MEAN_AVAILABILITY_LAST_12_HOURS_FIELD, arrivals.getLastMeanAvailability(MetricsInterval.HALF_DAY))
