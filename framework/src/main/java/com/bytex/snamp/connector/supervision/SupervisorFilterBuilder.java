...
import static com.bytex.snamp.connector.supervision.Supervisor.CATEGORY_PROPERTY;
...
public final class SupervisorFilterBuilder extends SimpleFilterBuilder {
    ...
    SupervisorFilterBuilder(final SupervisorConfiguration configuration){
        super(configuration);
        setSupervisorType(configuration.getType()).put(CATEGORY_PROPERTY, CATEGORY);
    }
