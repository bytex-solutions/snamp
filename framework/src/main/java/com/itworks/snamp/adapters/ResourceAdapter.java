...
public interface ResourceAdapter extends FrameworkService, ServiceListener, Closeable {
     ...
     *  and {@link com.itworks.snamp.connectors.attributes.AttributeSupport} are the forms in which
     *  resource connector representing attribute. {@link com.itworks.snamp.adapters.modeling.AttributeAccessor}
     *  is about representation of the attribute in the internal structure of the resource adapter.
     *  This interface provides information about how the {@link com.itworks.snamp.adapters.modeling.AttributeAccessor}
