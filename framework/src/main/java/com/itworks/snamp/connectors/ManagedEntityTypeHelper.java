...
public final class ManagedEntityTypeHelper {
    ...
    public static boolean supportsAllProjections(final ManagedEntityType entityType, final TypeToken<?>... projections){
        for(final TypeToken<?> p: projections)
     ...
     */
    @SuppressWarnings("UnusedDeclaration")
    public static boolean supportsAnyProjection(final ManagedEntityType entityType, final TypeToken<?>... projections){
        for(final TypeToken<?> p: projections)
     ...
     */
    public static boolean supportsProjection(final ManagedEntityType entityType, final TypeToken<?> projection){
     ...
     */
    public static <T> T convertFrom(final ManagedEntityType entityType, final Object value, final TypeToken<T> nativeType) throws IllegalArgumentException{
        if(entityType == null) throw new IllegalArgumentException("entityType is null.");
        else if(TypeLiterals.isInstance(value, nativeType)) return TypeLiterals.cast(value, nativeType);
    ...
    @SuppressWarnings("UnusedDeclaration")
    @SafeVarargs
    public static <T> T convertFrom(final ManagedEntityType entityType, final Object value, final TypeToken<T> baseType, final TypeToken<? extends T>... projections) throws IllegalArgumentException{
    ...
    @SuppressWarnings("UnusedDeclaration")
    @SafeVarargs
    public static <T> T convertFrom(final ManagedEntityType entityType, final Object value, final T defaultValue, final TypeToken<T> baseType, final TypeToken<? extends T>... projections){
        return convertFrom(entityType, value, baseType, new ConversionFallback<T>() {
            @Override
            public T call() {
                return defaultValue;
