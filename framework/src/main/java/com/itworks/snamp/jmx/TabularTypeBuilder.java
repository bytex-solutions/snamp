...
public final class TabularTypeBuilder extends AbstractAggregator implements OpenTypeBuilder<TabularType>, Iterable<String> {
    ...
    public final TabularTypeBuilder addStringColumn(final String columnName,
                                              final String columnDescription,
                                              final boolean indexed){
        rowBuilder.addStringItem(columnName, columnDescription);
        if(indexed)
            indexes.add(columnName);
        return this;
    }

    public final TabularTypeBuilder addBoolColumn(final String columnName,
                                              final String columnDescription,
                                              final boolean indexed){
        rowBuilder.addBoolItem(columnName, columnDescription);
        if(indexed)
            indexes.add(columnName);
        return this;
    }

    public final TabularTypeBuilder addCharColumn(final String columnName,
                                            final String columnDescription,
                                            final boolean indexed){
        rowBuilder.addCharItem(columnName, columnDescription);
        if(indexed)
            indexes.add(columnName);
        return this;
    }

    public final TabularTypeBuilder addByteColumn(final String columnName,
                                            final String columnDescription,
                                            final boolean indexed){
        rowBuilder.addByteItem(columnName, columnDescription);
        if(indexed)
            indexes.add(columnName);
        return this;
    }

    public final TabularTypeBuilder addShortColumn(final String columnName,
                                            final String columnDescription,
                                            final boolean indexed){
        rowBuilder.addShortItem(columnName, columnDescription);
        if(indexed)
            indexes.add(columnName);
        return this;
    }

    public final TabularTypeBuilder addIntColumn(final String columnName,
                                            final String columnDescription,
                                            final boolean indexed){
        rowBuilder.addIntItem(columnName, columnDescription);
        if(indexed)
            indexes.add(columnName);
        return this;
    }

    public final TabularTypeBuilder addLongColumn(final String columnName,
                                            final String columnDescription,
                                            final boolean indexed){
        rowBuilder.addLongItem(columnName, columnDescription);
        if(indexed)
            indexes.add(columnName);
        return this;
    }

    public final TabularTypeBuilder addFloatColumn(final String columnName,
                                            final String columnDescription,
                                            final boolean indexed){
        rowBuilder.addFloatItem(columnName, columnDescription);
        if(indexed)
            indexes.add(columnName);
        return this;
    }

    public final TabularTypeBuilder addDoubleColumn(final String columnName,
                                            final String columnDescription,
                                            final boolean indexed){
        rowBuilder.addDoubleItem(columnName, columnDescription);
        if(indexed)
            indexes.add(columnName);
        return this;
    }

    public final TabularTypeBuilder addDateColumn(final String columnName,
                                            final String columnDescription,
                                            final boolean indexed){
        rowBuilder.addDateItem(columnName, columnDescription);
        if(indexed)
            indexes.add(columnName);
        return this;
    }

    public final TabularTypeBuilder addBigIntColumn(final String columnName,
                                            final String columnDescription,
                                            final boolean indexed){
        rowBuilder.addBigIntItem(columnName, columnDescription);
        if(indexed)
            indexes.add(columnName);
        return this;
    }

    public final TabularTypeBuilder addBigDecimalColumn(final String columnName,
                                            final String columnDescription,
                                            final boolean indexed){
        rowBuilder.addBigDecimalItem(columnName, columnDescription);
        if(indexed)
            indexes.add(columnName);
        return this;
    }
