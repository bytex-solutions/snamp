...
public enum SnampFeature {
    ...
    SNMP_ADAPTER("snmp-adapter-feature", "2.0.0"),
    JMX_ADAPTER("jmx-adapter-feature", "2.0.0"),
    SNMP_CONNECTOR("snmp-connector-feature", "2.0.0"),
    RSHELL_CONNECTOR("rshell-connector-feature", "2.0.0"),
    SSH_ADAPTER("ssh-adapter-feature", "2.0.0"),
    WRAPPED_LIBS("wrapped-libs-for-tests", "2.0.0"),
    HTTP_ADAPTER("http-adapter-feature", "2.0.0"),
    RESOURCE_AGGREGATOR("aggregator-connector-feature", "2.0.0"),
    NSCA_ADAPTER("nsca-adapter-feature", "2.0.0"),
    NRDP_ADAPTER("nrdp-adapter-feature", "2.0.0"),
    NAGIOS_ADAPTER("nagios-adapter-feature", "2.0.0"),
    SYSLOG_ADAPTER("syslog-adapter-feature", "2.0.0"),
    XMPP_ADAPTER("xmpp-adapter-feature", "2.0.0"),
    GROOVY_CONNECTOR("groovy-connector-feature", "2.0.0"),
    GROOVY_ADAPTER("groovy-adapter-feature", "2.0.0"),
