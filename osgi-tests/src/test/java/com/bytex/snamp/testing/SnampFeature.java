...
public enum SnampFeature {
    ...
    HTTP_ACCEPTOR("connectors-features", "2.0.0", "http-acceptor"),
    JMX_CONNECTOR("connectors-features", "2.0.0", "jmx-connector"),
    ZIPKIN_CONNECTOR("connectors-features", "2.0.0", "zipkin-connector"),
    COMPOSITE_CONNECTOR("connectors-features", "2.0.0", "composite-connector"),
    ...
    SNMP_CONNECTOR("connectors-features", "2.0.0", "snmp-connector"),
    RSHELL_CONNECTOR("connectors-features", "2.0.0", "rshell-connector"),
    ...
    GROOVY_CONNECTOR("connectors-features", "2.0.0", "groovy-connector"),
    GROOVY_GATEWAY("groovy-gateway-feature", "2.0.0", "groovy-gateway-feature"),
    MODBUS_CONNECTOR("connectors-features", "2.0.0", "modbus-connector"),
