...
final class SnmpUnixTimeObject extends SnmpScalarObject<OctetString>{
     ...
     */
    private static interface DateTimeFormatter{
    ...
    private static DateTimeFormatter createFormatter(final Map<String, String> options){
        ...
        if(options.containsKey(DATE_TIME_DISPLAY_FORMAT_PROPERTY))
            switch (formatterName = options.get(DATE_TIME_DISPLAY_FORMAT_PROPERTY)){
    ...
    @Override
    public final void setAttributeOptions(final Map<String, String> options) {
