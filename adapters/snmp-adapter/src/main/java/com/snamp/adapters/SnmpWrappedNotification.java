...
final class SnmpWrappedNotification extends SnmpNotification {
     ...
     *     <ul>
     *         <li>{@link com.snamp.connectors.NotificationSupport.Notification#getMessage()} into OID .1</li>
     *         <li>{@link com.snamp.connectors.NotificationSupport.Notification#getSeverity()} ordinal into OID .2</li>
     *         <li>{@link com.snamp.connectors.NotificationSupport.Notification#getSequenceNumber()} into OID .3</li>
     *     </ul>
     * </p>
     ...
     *         <li>{@link com.snamp.connectors.NotificationSupport.Notification#getSeverity()} ordinal into OID .2</li>
     *         <li>{@link com.snamp.connectors.NotificationSupport.Notification#getSequenceNumber()} into OID .3</li>
     *         <li>{@link com.snamp.connectors.NotificationSupport.Notification#getTimeStamp()} into OID .4</li>
     *     </ul>
     * </p>
     * @param notificationID The notification identifier.
     * @param n The notification to wrap.
