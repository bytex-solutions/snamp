...
public class WebconsoleActivator implements BundleActivator {
    ...
    public static final String JERSEY_HTTP_SERVICE = "/rest";
    private BundleContext bc;
    private ServiceTracker tracker;
    private HttpService httpService = null;
    private static final Logger logger = Logger.getLogger(WebconsoleActivator.class.getName());
    ...
    private void rawRegisterServlets() throws ServletException, NamespaceException, InterruptedException {
        ...
        try {
            ...
            httpService.registerServlet(JERSEY_HTTP_SERVICE, new ServletContainer(), getJerseyServletParams(), null);
        } finally {
    ...
    private void unregisterServlets() {
        if (this.httpService != null) {
            ...
            httpService.unregister(JERSEY_HTTP_SERVICE);
