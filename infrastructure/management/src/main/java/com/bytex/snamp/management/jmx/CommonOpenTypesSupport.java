...
interface CommonOpenTypesSupport<T extends MBeanFeatureInfo> extends Supplier<T> {
    ...
    TabularType SIMPLE_MAP_TYPE = interfaceStaticInitialize(
            () -> new TabularTypeBuilder("com.bytex.management.map",
     ...
     */
    CompositeTypeBuilder EVENT_METADATA_BUILDER = new CompositeTypeBuilder("com.bytex.management.EventMetadata", "SNAMP Connector Event Metadata")
            .addItem("AdditionalProperties", "User defined property for event", SIMPLE_MAP_TYPE);

    /**
     * The ATTRIBUTE_METADATA_BUILDER.
     */
    CompositeTypeBuilder ATTRIBUTE_METADATA_BUILDER = new CompositeTypeBuilder("com.bytex.management.AttributeMetadata", "SNAMP connector attribute metadata scheme")
