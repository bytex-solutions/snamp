 ...
 */
final class GetInstalledAdaptersOperation extends InstalledComponents  {

    private static final String NAME = "getInstalledAdaptersOperation";

    GetInstalledAdaptersOperation(final SnampManager manager) throws OpenDataException{
        super(NAME, manager);
    }
